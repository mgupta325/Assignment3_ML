...
plt.title('visualization of data in 2D (pca)-> tic-tac toe dataset')
plt.show()
...
plt.ylabel('variance')
plt.title('distribution of eigenvalues of tic tac toe dataset')

plt.subplot(2,1,2)
plt.plot(x1,r1)
plt.xlabel('number of components')
plt.ylabel('error')
plt.title('reconstruction error of tic tac toe dataset')
